			...
			type: 'GET',
  			...
  			success: function(data){
    			...
    			$.each(flickrResults, function(i,item){
    			    ...
    			    //create image urls
    			    var photoURL = 'https://farm' + item.farm + '.static.flickr.com/' + item.server + '/' + item.id + '_' + item.secret + '_' + options.image_size + '.jpg';
    			    var thumbURL = 'https://farm' + item.farm + '.static.flickr.com/' + item.server + '/' + item.id + '_' + item.secret + '_t.jpg';
